...
func TestRewritePreflightWriteKeyEndpoint(t *testing.T) {
		...
		Encryption: &apiserverconfigv1.EncryptionConfiguration{
			Resources: []apiserverconfigv1.ResourceConfiguration{{
				...
				Providers: []apiserverconfigv1.ProviderConfiguration{
					{KMS: &apiserverconfigv1.KMSConfiguration{Name: "2", Endpoint: "unix:///var/run/kmsplugin/kms-2.sock"}},
					{KMS: &apiserverconfigv1.KMSConfiguration{Name: "1", Endpoint: "unix:///var/run/kmsplugin/kms-1.sock"}},
				},
			}},
		},
	})
	...
	require.Error(t, err)
	require.Contains(t, err.Error(), `write-key KMS endpoint "unix:///var/run/kmsplugin/kms-99.sock" not found`)
}
