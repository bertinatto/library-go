...
// IncludePlannedKey compute (via PlanNextEncryptionKey, without endpoint override)
// must match what the state controller would Apply after the planned key Secret
// is persisted.
