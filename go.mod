...
replace (
	...
	k8s.io/api => k8s.io/api master
	k8s.io/apimachinery => k8s.io/apimachinery master
	k8s.io/apiextensions-apiserver => k8s.io/apiextensions-apiserver master
	k8s.io/apimachinery => k8s.io/apimachinery master
	k8s.io/apiserver => k8s.io/apiserver master
	k8s.io/client-go => k8s.io/client-go master
	k8s.io/component-base => k8s.io/component-base master
	k8s.io/kube-aggregator => k8s.io/kube-aggregator master
)